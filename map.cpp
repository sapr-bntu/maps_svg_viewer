...
connect(ui->verticalWidget,SIGNAL(customContextMenuRequested(QPoint)),this,SLOT(otrisovka(QPoint)));
...
void map::otrisovka(QPoint p)
{
    qDebug()<<"asdad";
    QLabel *l;
    l = new QLabel("l",ui->verticalWidget);
    l->move(p);
    l->show();
}
